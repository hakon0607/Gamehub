...
const ENTRIES: { id: string; category: SettingsCategory; keywords: string }[] = [
  ...
  { id: 'startup-animation', category: 'general', keywords: 'startup splash animation intro logo open launch oppstart' },
  { id: 'startup-on-reopen', category: 'general', keywords: 'startup animation tray reopen every time open again hver gang' },
  { id: 'startup-sound', category: 'general', keywords: 'startup sound chime intro open launch lyd oppstart' },
